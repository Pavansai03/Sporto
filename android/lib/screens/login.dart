...
class _LoginState extends State<Login> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Header Row aligned to match Register page
                  Row(
                  ...
                  const Text("Lesgooo....", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.white)),
                  const SizedBox(height: 12),
                  const Text('Enter your info to sign in or get started with a new account', style: TextStyle(color: Colors.grey, fontSize: 18)),
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildMainButton('Sign In', controller.isLoginLoading, () {
                          if (_formkey.currentState!.validate()) {
                            controller.login(email, password);
                          }
                        }),
                        const SizedBox(height: 20),
                        const Center(child: Text('--or--', style: TextStyle(color: Colors.white, fontSize: 15))),
                        const SizedBox(height: 20),
                        _buildGoogleButton(),
                        const SizedBox(height: 20),
                        Row(
                          ...
                          children: [
                            const Text(
                              ...
                              style: TextStyle(color: Colors.white), // Added comma here
                            ),
                            TextButton(
  ...
  Widget _buildMainButton(String label, RxBool loading, VoidCallback onPressed) {
    return Obx(() => ElevatedButton(
      style: ElevatedButton.styleFrom(backgroundColor: const Color.fromRGBO(61, 205, 22, 1.0), foregroundColor: Colors.white, minimumSize: const Size.fromHeight(50), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
      onPressed: onPressed,
